...
def install():
    ...
    _install_bot(
        ...
        "time, in this order -- and see the whole sequence through, even if "
        "they go quiet for a turn or ask something else in between:\n"
        ...
        "If they ask for something outside the offerings below, say so "
